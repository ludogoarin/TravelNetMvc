<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinkBrowser.aspx.cs" Inherits="Caval_go.Content.ckeditor.LinkBrowser" %>
        ...
        <table width="100%" cellpadding="10" cellspacing="0" border="1" style="background-color:#F1F1E3;">
            <tr>
                <td valign="top">
                    ...
                    <asp:Button ID="testbt" runat="server" Text="my test" />

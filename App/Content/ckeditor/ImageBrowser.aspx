<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImageBrowser.aspx.cs" Inherits="Caval_go.Content.ckeditor.ImageBrowser" %>
...
<body>
	...
	<div>
		...
		<h1>Image Browser</h1>
        <asp:Label ID="lbl_GnlMsg" runat="server" Text=""></asp:Label>

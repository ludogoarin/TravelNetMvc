<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/admin.Master" Inherits="System.Web.Mvc.ViewPage<Caval_go.Models.cg_Destinations_Info>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Edition de Destination par Langue
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

    <h2>Edition de Destination par Langue</h2>
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <fieldset>
            ...
            <%= Html.HiddenFor(model => model.DestinationInfoId) %>
            
            <div class="editor-label">
                <label for="Title">Nom de la destination</label>
            </div>
            <div class="editor-field">
                <%= Html.TextBox("Title", Model.Name) %>
    ...
    <div>
        <%= Html.ActionLink("< Retour", "destination_infos", new { id = Model.DestinationId })%>
    </div>

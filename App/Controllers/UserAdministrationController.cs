...
namespace SampleWebsite.Controllers
{
	...
	{
        private int PageSize = Convert.ToInt32(ConfigurationManager.AppSettings["UserListPageSize"]); // 10;
        private string ResetPasswordBody = ConfigurationManager.AppSettings["ResetPasswordBody"]; // "Your new password is: ";
        private string ResetPasswordFromAddress = ConfigurationManager.AppSettings["ResetPasswordFromAddress"]; // "from@domain.com";
        private string ResetPasswordSubject = ConfigurationManager.AppSettings["ResetPasswordSubject"]; // "Your New Password";
